...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { body: @info.body, description: @info.description, keywords: @info.keywords, link: @info.link, name: @info.name, title: @info.title } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { body: @info.body, description: @info.description, keywords: @info.keywords, link: @info.link, name: @info.name, title: @info.title } }
