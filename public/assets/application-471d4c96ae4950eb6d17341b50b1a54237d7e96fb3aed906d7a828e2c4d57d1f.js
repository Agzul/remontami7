...
(function() {
  this.global_variables = function() {
    ...
    this.current_controller = current_page[0];
    this.current_action = current_page[1];
  };

  this.update_dom = function() {
    return $(".update-dom").click(function() {
      setTimeout(function() {
  ...
  this.add_label_for_image_form = function() {
    if ($(document).find(".uploadBtn")) {
      $(".uploadBtn").change(function() {
        var uploadFile;
        uploadFile = $(this).parent().parent().find(".uploadFile")[0];
        return uploadFile.value = this.files[0].name;
      });
    }
    return $(document).on("fields_added.nested_form_fields", function(event) {
      var uploadBtn;
  ...
  this.dropdown = function() {
    return $("[data-toggle='dropdown']").click(function() {
      var arrow, dropdown_content;
...
(function() {
  ...
  this.set_cover = function() {
    var galleriesUrls, i, j, ref, results;
    galleriesUrls = $(".temp_information").data("galleriesUrls");
    results = [];
    for (i = j = 0, ref = galleriesUrls.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
      results.push(console.log(galleriesUrls[i].split(',')));
    }
    return results;
  };

  all_ready = function() {
    if (this.current_controller === "galleries" && this.current_action === "index") {
      return window.set_cover();
    }
  };
...
(function() {
  ...
  this.calculator = function() {
    ...
    $('#pol1').click(function() {
      if (q % 2 === 0) {
        ...
        $('.calculator .calculator_second_step #hidden_form_pol1 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    $('#potolok1').click(function() {
      if (w % 2 === 0) {
        ...
        $('.calculator .calculator_second_step #hidden_form_potolok1 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    e = 0;
    $('#potolok1_2').click(function() {
      if (e % 2 === 0) {
        $('#hidden_form_potolok1_2').show();
      } else {
        $('#hidden_form_potolok1_2').hide();
        $('.calculator .calculator_second_step #hidden_form_potolok1_2 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    r = 0;
    $('#potolok2').click(function() {
      if (r % 2 === 0) {
        $('#hidden_form_potolok2').show();
      } else {
        $('#hidden_form_potolok2').hide();
        $('.calculator .calculator_second_step #hidden_form_potolok2 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    t = 0;
    $('#steny2').click(function() {
      if (t % 2 === 0) {
        $('#hidden_form_steny2').show();
      } else {
        $('#hidden_form_steny2').hide();
        $('.calculator .calculator_second_step #hidden_form_steny2 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    y = 0;
    $('#steny4').click(function() {
      if (y % 2 === 0) {
        $('#hidden_form_steny4').show();
      } else {
        $('#hidden_form_steny4').hide();
        $('.calculator .calculator_second_step #hidden_form_steny4 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    u = 0;
    $('#steny5').click(function() {
      if (u % 2 === 0) {
        $('#hidden_form_steny5').show();
      } else {
        $('#hidden_form_steny5').hide();
        $('#hidden_form_steny5_1').hide();
        $('.calculator .calculator_second_step #hidden_form_steny5 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    $('#steny5_1').click(function() {
      return $('#hidden_form_steny5_1').show();
    });
    $('#steny5_2').click(function() {
      $('#hidden_form_steny5_1').hide();
      return $('.calculator .calculator_second_step #hidden_form_steny5_1 input').each(function() {
        var elem;
        elem = $(this)[0];
        elem.checked = false;
      });
    ...
    $('#steny6').click(function() {
      if (o % 2 === 0) {
        ...
        $('.calculator .calculator_second_step #hidden_form_steny6 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    a = 0;
    $('#steny6_1').click(function() {
      if (a % 2 === 0) {
        $('#hidden_form_steny6_1').show();
      } else {
        $('#hidden_form_steny6_1').hide();
        $('.calculator .calculator_second_step #hidden_form_steny6_1 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    p = 0;
    $('#steny8').click(function() {
      if (p % 2 === 0) {
        $('#hidden_form_steny8').show();
      } else {
        $('#hidden_form_steny8').hide();
        $('.calculator .calculator_second_step #hidden_form_steny8 input').each(function() {
          var elem;
          elem = $(this)[0];
          elem.checked = false;
        });
    ...
    $('.calculator').click(function() {
      var area, area_price, distance, height, length, perimeter, perimeter_price, price, sum_area, sum_perimeter, width;
      width = $('#width')[0].value;
      ...
      if (isNaN(width) || isNaN(length) || isNaN(height) || isNaN(distance)) {
      ...
      sum_area = 0;
      $('.calculator .calculator_second_step #section_area input').each(function() {
        var elem;
        elem = $(this)[0];
      ...
      sum_perimeter = 0;
      $('.calculator .calculator_second_step #section_perimeter input').each(function() {
        var elem;
        elem = $(this)[0];
        if (elem.checked === true) {
      ...
      return $('#price')[0].innerHTML = price.toFixed(2);
    });
  };

  this.calculator_clear_checked = function() {
  ...
  this.table_calculator = function() {
    var form;
    $('.mdl-data-table').find("tr:last").after('<td></td> <td></td> <td>Стоимость за 1 ед.: <div class="sum">0</div> руб</td>');
    form = $('.works_table');
  ...
  all_ready = function() {
    if (this.current_controller === "main_menu" && this.current_action === "prices") {
      window.calculator();
      window.calculator_clear_checked();
      return window.table_calculator();
    }
  };
