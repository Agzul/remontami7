...
Material.create([
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Универсальная сухая смесь М-150 "<em>Русеан</em>" <a rel="nofollow" href="http://rusean.ru/catalog/suhie-smesi/product/smes-suhaja-universalnaja-m150" target="_blank">описание</a>',
    packing: "40 кг",
    layer_thickness: "1 см",
    consumption: 18,
    consumption_unit: "кг"
  },
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Смесь гипсовая штукатурная "<em>Ротбанд</em>" <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=44416ef1-f1dc-4f76-b98b-c78387b70305" target="_blank">описание</a>',
    packing: "30 кг",
    layer_thickness: "1 см",
    consumption: 8.5,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Штукатурка гипсовая "<em>Старатели</em>" <a rel="nofollow" href="http://shtukaturka.starateli.ru/gipsovaya/" target="_blank">описание</a>',
    packing: "30 кг",
    layer_thickness: "1 см",
    consumption: 9,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Штукатурка гипсовая "<em>Волма-слой</em>" <a rel="nofollow" href="http://www.volma.ru/production/catalog/plaster/volma-sloy/" target="_blank">описание</a>',
    packing: "30 кг",
    layer_thickness: "1 см",
    consumption: 9,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Штукатурка гипсовая "<em>Основит гипсвэлл</em>" (серый) <a rel="nofollow" href="http://www.osnovit.ru/produktsiya/shtukaturki-gipsovye/osnovit-gipsvell-seraya-pg-25-shtukaturka-gipsovaya-universalnaya/" target="_blank">описание</a>',
    packing: "30 кг",
    layer_thickness: "1 см",
    consumption: 9,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Штукатурка гипсовая Юнис "<em>Теплон</em>" белый/серый <a rel="nofollow" href="http://unistrom.ru/catalog/shtukaturki/teplon-belyj_30/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 9,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Маячки штукатурные оцинкованные',
    packing: "3 метра",
    layer_thickness: "",
    consumption: 1,
    consumption_unit: "шт"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Грунтовка "<em>Бетоконтакт</em>" <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=10da7bed-7891-46d5-a46e-ec9d5c5081a3" target="_blank">описание</a>',
    packing: "20 кг",
    layer_thickness: "1 слой",
    consumption: 0.35,
    consumption_unit: "кг"
  },
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Грунтовка "<em>Тифенгрунт</em>" <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=d74cd194-f4ba-4785-b89b-71346157cabb" target="_blank">описание</a>',
    packing: "10 кг",
    layer_thickness: "1 слой",
    consumption: 0.1,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Шпатлевка <em>Vetonit LR+ &nbsp;<a rel="nofollow" href="http://www.weber-vetonit.ru/shtukaturki-shpaklevki/materialy/shpaklevki/webervetonit-lr.html" target="_blank">описание</a><br></em>',
    packing: "25 кг",
    layer_thickness: "1 слой (1 мм)",
    consumption: 1.2,
    consumption_unit: "кг"
  },
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Шпатлевка <em>Vetonit KR&nbsp; <a rel="nofollow" href="http://www.weber-vetonit.ru/shtukaturki-shpaklevki/materialy/shpaklevki/webervetonit-kr.html" target="_blank">описание</a><br></em>',
    packing: "25 кг",
    layer_thickness: "1 слой (1 мм)",
    consumption: 1.2,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Шпатлевка <em>Sheetrock (Шитрок)<br></em>',
    packing: "28 кг",
    layer_thickness: "1 слой (1 мм)",
    consumption: 0.67,
    consumption_unit: "кг"
  ...
  {
    material_type: "Штукатурки. шпатлевки",
    name: 'Шпатлевка "Кнауф-<em>Унифлот</em>" для монтажа ГКЛ, заделки швов (стены) <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=7a2f5176-07f2-41fd-9109-85454fc90748" target="_blank">описание</a>',
    packing: "",
    layer_thickness: "",
    consumption: 0.5,
    consumption_unit: "кг"
  ...
  {
    material_type: "Клеи",
    name: 'Клей обойный "Quelyd" экспресс супер <a rel="nofollow" href="http://bostik.ru/catalog/ss/sten/klei/28528" target="_blank">описание</a>',
    packing: "0,25 кг",
    layer_thickness: "",
    consumption: "",
    consumption_unit: ""
  ...
  {
    material_type: "Клеи",
    name: 'Клей плиточный "<em>Кнауф-Флизен</em>"&nbsp; <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=4b052579-1c07-4181-8048-f95b6c72be93" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "сторона плитки до 20мм",
    consumption: 2.2,
    consumption_unit: "кг"
  },
  {
    material_type: "Клеи",
    name: 'Клей плиточный <em>Ceresit CM17</em>&nbsp;для мозаичных работ <a rel="nofollow" href="http://www.ceresit.ru/ru/products/tiling/tile-adhesives/cm-12-adhesive-mortar-elastic12.html" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "сторона плитки до 100мм",
    consumption: 1.8,
    consumption_unit: "кг"
  },
  {
    material_type: "Клеи",
    name: 'Клей плиточный универсальный <em>Ceresit CM9 Plus&nbsp;<a rel="nofollow" href="http://www.ceresit.ru/ru/products/tiling/tile-adhesives/cm-11-comfort-ceramic-tile-mortar1.html" target="_blank">описание</a><br></em>',
    packing: "25 кг",
    layer_thickness: "сторона плитки до 200мм",
    consumption: 3.2,
    consumption_unit: "кг"
  },
  {
    material_type: "Клеи",
    name: 'Клей плиточный "<em>Юнис Плюс</em>" <a rel="nofollow" href="http://unistrom.ru/catalog/plitochnye-klei/unis-plus_3/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "плитка 60х60 см",
    consumption: 3.5,
    consumption_unit: "кг"
  },
  {
    material_type: "Клеи",
    name: 'Плита гипсовая пазогребневая (ПГП)',
    packing: "667х500х80 мм",
    layer_thickness: "",
    consumption: 3,
    consumption_unit: "шт"
  },
  {
    material_type: "Клеи",
    name: 'Смесь гипсовая "<em>Кнауф-Фуген</em>" для монтажа ПГП 80 мм <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=71bfd836-cc19-48fc-9394-dbf24c08308b" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 слой",
    consumption: 2,
    consumption_unit: "кг"
  ...
  # Стяжка
  {
    material_type: "Стяжка",
    name: 'Пескобетон М-300 на основе цемента',
    packing: "40 кг",
    layer_thickness: "1 см",
    consumption: 20,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Стяжка для пола "<em>Геркулес</em>" <a rel="nofollow" href="http://www.gerkules.ru/catalog/floor/screed/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 20,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Стяжка легкая "<em>Основит Иннолайн Т-43</em>" <a rel="nofollow" href="http://www.osnovit.ru/catalog/styazhki/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 12,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Стяжка быстротвердеющая "<em>БИРСС Рапид-2</em>" (1 ч смесь: 2 ч заполнитель) <a rel="nofollow" href="http://www.birss.ru/catalog/index.php?SECTION_ID=49&amp;ELEMENT_ID=434" target="_blank">описание</a>',
    packing: "50кг/25 кг",
    layer_thickness: "1 см",
    consumption: 23,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Стяжка цементная М-200 "<em>Юнис Горизонт</em>" <a rel="nofollow" href="http://www.unistrom.ru/catalog/pol_gorizont.php" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 20,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Стяжка цементная легкая "<em>Кнауф-Убо</em>" <a rel="nofollow" href="http://www.knauf.ru/products/materials/product.wbp?root_id=fcb4c662-59a5-476e-9aa1-9a1db5c39316" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 7.5,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Сетка металлическая для армирования (карты)',
    packing: "50х50х4 мм",
    layer_thickness: "на 1 м.кв.",
    consumption: 1.2,
    consumption_unit: "шт"
  },
  {
    material_type: "Стяжка",
    name: 'Стекловолокно для армирования стяжки фиброй',
    packing: "12-18 мм",
    layer_thickness: "на 1 м.куб",
    consumption: 2,
    consumption_unit: "кг"
  },
  {
    material_type: "Стяжка",
    name: 'Звукоизоляция "<em>Шуманет-100</em>" рулон толщ 3 мм <a rel="nofollow" href="http://www.shumanet.ua/productions/zvukoizolyaciya_pola/akuflex_super/" target="_blank">описание</a>',
    packing: "ширина рулона 1 м",
    layer_thickness: "",
    consumption: 1.1,
    consumption_unit: "м"
  },
  {
    material_type: "Стяжка",
    name: 'Грунтовка <em>Vetonit MD16</em> дисперсия <a rel="nofollow" href="http://www.weber-vetonit.ru/materialy-dlja-vyravnivanija-polov/materialy/gruntovki/webervetonit-md-16.html" target="_blank">описание</a>',
    packing: "10 л",
    layer_thickness: "1 слой",
    consumption: 0.1,
    consumption_unit: "л"
  ...
  {
    material_type: "Стяжка",
    name: 'Смесь самовыравнивающаяся "<em>Vetonit 3000</em>" <a rel="nofollow" href="http://www.weber-vetonit.ru/materialy-dlja-vyravnivanija-polov/materialy/nalivnye-poly-bytovyekommercheskie/webervetonit-3000.html" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 слой",
    consumption: 1.5,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Пол наливной "<em>Геркулес Стандарт</em>" <a rel="nofollow" href="http://www.gerkules.ru/catalog/floor/floor_loading_standard/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 мм",
    consumption: 1.53,
    consumption_unit: "кг"
  },
  {
    material_type: "Стяжка",
    name: 'Самовыравнивающийся пол "<em>Геркулес</em>" <a rel="nofollow" href="http://www.gerkules.ru/catalog/floor/self_leveling_floor/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 мм",
    consumption: 1.72,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Наливной пол "<em>Основит Скорлайн FK48</em>" <a rel="nofollow" href="http://osnovit.ru/products/nalivnye_poly/60/" target="_blank">описание</a>',
    packing: "20 кг",
    layer_thickness: "1 см",
    consumption: 15,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Быстротвердеющий наливной пол "<em>Старатели</em>" 5-80 мм <a rel="nofollow" href="http://poli-nalivniye.starateli.ru/nalivnoi_pol_bistrodeistvuyushiy/#" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 16,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Универсальный быстротвердеющий наливной пол <em>"Юнис Горизонт" <a rel="nofollow" href="http://www.unistrom.ru/catalog/pol_gorizont.php" target="_blank">описание</a><br></em>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 17,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Тонкослойный наливной пол "<em>Юнис Горизонт-2</em>" <a rel="nofollow" href="http://unistrom.ru/catalog/rovniteli-dlya-pola/gorizont-2_24/" target="_blank">описание</a>',
    packing: "25 кг",
    layer_thickness: "1 см",
    consumption: 13,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Гипсовый наливной пол "<em>Юнис Эко-пол</em>" для плавающего пола <a rel="nofollow" href="http://unistrom.ru/catalog/rovniteli-dlya-pola/gorizont-eko-pol_25/" target="_blank">описание</a>',
    packing: "30 кг",
    layer_thickness: "1 см",
    consumption: 13,
    consumption_unit: "кг"
  ...
  {
    material_type: "Стяжка",
    name: 'Утеплитель Rockwool Лайт Батс 1х0,6х0,1 м',
    packing: "в упаковке 3 м<sup>2</sup>",
    layer_thickness: "",
    consumption: 0.6,
    consumption_unit: "уп"
  },
  # Краски Dulux
  {
    material_type: '<strong>Краски Dulux</strong>&nbsp;<a rel="nofollow" href="http://www.dulux.ru/products/" target="_blank">описание</a>',
    name: 'Dulux Trade Diamond Matt (GB)',
    shine: 7,
    second_layer_time: 6,
    consumption: 17,
    consumption_unit: "м<sup>2</sup>"
  },
  {
    material_type: '<strong>Краски Dulux</strong>&nbsp;<a rel="nofollow" href="http://www.dulux.ru/products/" target="_blank">описание</a>',
    name: 'Dulux Trade Vinyl Matt (GB)',
    shine: 7,
    second_layer_time: 4,
    consumption: 17,
    consumption_unit: "м<sup>2</sup>"
  ...
  {
    material_type: '<strong>Краски Dulux</strong>&nbsp;<a rel="nofollow" href="http://www.dulux.ru/products/" target="_blank">описание</a>',
    name: 'Dulux Realife Kitchen Matt (GB)',
    shine: 7,
    second_layer_time: 6,
    consumption: 13,
    consumption_unit: "м<sup>2</sup>"
  ...
  # Краски Sikkens
  {
    material_type: 'Краски Sikkens',
    name: 'Sikkens Alfhacryl Plafond',
    shine: 3,
    second_layer_time: 5,
    consumption: 10,
    consumption_unit: "м<sup>2</sup>"
  ...
  # Краски Beckers
  {
    material_type: 'Краски Beckers',
    name: 'Beckers Beckerplast 7 <a rel="nofollow" href="http://www.beckers-design.ru/shop/steny-i-potolki/beckerplast-7-kraska-dlya-sten-i-potolkov-detail" target="_blank">описание</a>',
    shine: 7,
    second_layer_time: 3,
    consumption: 8,
    consumption_unit: "м<sup>2</sup>"
  ...
  {
    material_type: 'Краски Beckers',
    name: 'Beckers Beckerplast 3 <a rel="nofollow" href="http://www.beckers-design.ru/shop/steny-i-potolki/beckerplast-3-kraska-dlya-sten-i-potolkov-detail" target="_blank">описание</a>',
    shine: 3,
    second_layer_time: 3,
    consumption: 8,
    consumption_unit: "м<sup>2</sup>"
